<footer class="bg-brand-emerald text-parchment mt-40">
    <div class="relative py-24 lg:py-32">
        ...
        <div class="container-wide grid md:grid-cols-4 gap-16 relative z-10">
            ...
            <div class="md:col-span-1">
                <h3 class="text-3xl font-serif italic mb-8">Royal Dine</h3>
                <p class="text-parchment/70 text-sm leading-relaxed mb-10 max-w-xs">
                    Curating the finest heritage recipes of Bengal with a commitment to culinary excellence and royal hospitality.
                </p>
                <div class="flex gap-6">
                    <a href="#" class="text-brand-gold hover:text-parchment transition-colors uppercase text-[10px] font-black tracking-widest">Instagram</a>
                    <a href="#" class="text-brand-gold hover:text-parchment transition-colors uppercase text-[10px] font-black tracking-widest">Facebook</a>
                </div>
            </div>
            ...
            <div class="md:col-span-1">
                ...
                <ul class="flex flex-col gap-6 text-sm font-medium text-parchment/80">
                    <li class="flex flex-col gap-1">
                        ...
                        <span>Banani Rd 11, Block H, Dhaka</span>
                    </li>
                    <li class="flex flex-col gap-1">
    ...
    <div class="border-t border-white/5 py-10">
        <div class="container-wide flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase font-bold tracking-widest text-parchment/40">
            <p>&copy; 2024 Royal Dine Heritage. All rights reserved.</p>
